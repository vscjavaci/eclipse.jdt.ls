 ...
 *
 * Code copied from org.eclipse.debug.core.model.IDisconnect
 *
 * Contributors:
...
public interface IDisconnect {
    ...
    /**
     * Disconnects this element from its target. Generally, disconnecting ends a
     * debug session with a debug target, but allows the target program to
     * continue running.
     *
     * @exception DebugException
     *                on failure. Reasons include:
     *                <ul>
     *                <li>TARGET_REQUEST_FAILED - The request failed in the
     *                target
     *                <li>NOT_SUPPORTED - The capability is not supported by the
     *                target
     *                </ul>
     */
